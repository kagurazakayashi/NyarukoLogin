...
class YaloginGlobal
{
	...
	public $erroridArr = array(
		...
		'90404' => "验证码包含不允许的特殊字符。",
		'90901' => "尚未登录。", //用户
		'90902' => "没有返回任何数据。", //找到多个用户数据。
		'90903' => "没有找到这个用户数据。", 
		'90904' => "需要更多信息才能完成登录步骤。", 
		'90905' => "无效的数据范围。", 
		'1000' => "用户登录成功。",
		'1001' => "用户注册成功。", //成功
		...
		'1006' => "查询用户信息成功。",
		'1007' => "用户不需要扩展验证。",
		'1008' => "通过邮件变更密码成功。", //允许用户修改密码。
		'1009' => "正在找回密码。向您发送了一封激活电子邮件，请按电子邮件中说明的步骤修改密码。如果没有收到，请检查输入的邮箱是否正确，或是否在垃圾邮件中。"
		);
