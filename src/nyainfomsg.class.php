...
class nyainfomsg {
    public $imsg = array(
        ...
        */
        ...
        ///// A=2\BB=02\CC=02\DD=08 :
        2020208 => '内部错误：不是有效的 RGB 颜色表述。',
        ///// A=2\BB=02\CC=02\DD=09 :
        2020209 => '内部错误：用户代码不正确。',
        //// A=2\BB=02\CC=03 : 合规性检查
        ///// A=2\BB=02\CC=03\DD=00 :
        2020300 => '错误：包含可能违禁的词汇。',
        ///// A=2\BB=02\CC=03\DD=01 :
        2020301 => '内部错误：词汇数据库设置不正确。',
        ///// A=2\BB=02\CC=03\DD=02 :
        2020302 => '内部错误：词汇文件加载失败。',
        ///// A=2\BB=02\CC=03\DD=03 :
        2020303 => '内部错误：词汇资料库加载失败。',
        ...
        2020600 => '错误：验证码不正确',
        ///// A=2\BB=02\CC=06\DD=01 :
        2020601 => '错误：目前还不能获取新的验证码',
        ///// A=2\BB=02\CC=06\DD=02 :
        2020602 => '内部错误：验证码存储失败',
        ///// A=2\BB=02\CC=06\DD=03 :
        2020603 => '错误：验证码超过最大尝试次数，请重新获取',
        ///// A=2\BB=02\CC=06\DD=04 :
        2020604 => '错误：验证码无效或超时，请重新获取',
        ///// A=2\BB=02\CC=06\DD=05 :
        2020605 => '内部错误：不支持的验证码类型',
        /// A=2\BB=03 : 验证信息问题
        //// A=2\BB=03\CC=01 : 密码
        ...
        2040102 => '错误：手机或邮箱已被注册',
        ///// A=2\BB=04\CC=01\DD=03 :
        2040103 => '内部错误：不允许使用这种方式注册',
        ///// A=2\BB=04\CC=01\DD=04 :
        2040104 => '错误：电子邮件地址太长',
        ///// A=2\BB=04\CC=01\DD=05 :
        2040105 => '错误：昵称太长',
        ///// A=2\BB=04\CC=01\DD=06 :
        2040106 => '内部错误：生成用户名标识号没有成功，请更换另一个昵称',
        ...
        2040113 => '内部错误：未能生成用户标识码',
        ///// A=2\BB=04\CC=01\DD=14 :
        2040114 => '内部错误：查询用户名标识号没有成功',
        ///// A=2\BB=04\CC=01\DD=15 :
        2040115 => '内部错误：不允许使用这种方式登录',
        //// A=2\BB=04\CC=2 : 用户登入
        ...
        2040305 => '错误：无效的恢复代码',
        ///// A=2\BB=04\CC=03\DD=06 :
        2040306 => '内部错误：未能删除临时用户令牌',
        //// A=2\BB=04\CC=4 : 状态查询
        ...
        //// A=2\BB=04\CC=6 : 资料修改
        ///// A=2\BB=04\CC=06\DD=00 :
        2040600 => '内部错误：无效的性别参数',
        ///// A=2\BB=04\CC=06\DD=01 :
        2040601 => '内部错误：无效的人称参数',
        ///// A=2\BB=04\CC=06\DD=02 :
        2040602 => '错误：地址太长',
        ///// A=2\BB=04\CC=06\DD=03 :
        2040603 => '错误：签名太长',
        ///// A=2\BB=04\CC=06\DD=04 :
        2040604 => '内部错误：资料更新失败。',
        ///// A=2\BB=04\CC=06\DD=05 :
        2040605 => '内部错误：性别信息加载失败。',
        //// A=2\BB=05\CC=07 : 用户登出
        ///// A=2\BB=04\CC=07\DD=00 :
        2040700 => '内部错误：登出失败。',
        ///// A=2\BB=04\CC=02\DD=11 :
        2040711 => '内部错误：自动登出旧客户端失败。',
        ///// A=2\BB=04\CC=02\DD=12 :
        2040712 => '内部错误：自动登出旧客户端信息获取失败。',
        ///// A=2\BB=04\CC=02\DD=13 :
        2040713 => '内部错误：密钥注销失败。',
        //// A=2\BB=05\CC=08 : 用户信息查询
        ///// A=2\BB=04\CC=08\DD=00 :
        2040800 => '内部错误：没有找到用户所在用户组。',
        /// A=2\BB=05 : 文件系统操作
        ...
        ///// A=2\BB=05\CC=01\DD=07 :
        2050107 => '内部错误：文件路径不正确',
        ...
        2070004 => "内部错误：子账户无效。",
        ///// A=2\BB=07\CC=00\DD=05 :
        2070005 => "内部错误：不正确的昵称分隔格式。",
        ...
        /// A=2\BB=08 : 信息中心
        //// A=2\BB=08\CC=00 : 通用信息处理
        ///// A=2\BB=08\CC=00\DD=00 :
        2080000 => "内部错误：未能检查通知相似性。",
        ///// A=2\BB=08\CC=00\DD=01 :
        2080001 => "内部错误：未能合并通知信息。",
        ///// A=2\BB=08\CC=00\DD=02 :
        2080002 => "内部错误：未能建立通知信息。",
        ///// A=2\BB=08\CC=00\DD=03 :
        2080003 => "内部错误：未能获得通知列表。",
        ///// A=2\BB=08\CC=00\DD=04 :
        2080004 => "内部错误：找不到预定义的通知类型。",
        ///// A=2\BB=08\CC=00\DD=05 :
        2080005 => "内部错误：修改通知状态失败。",
        ///// A=2\BB=08\CC=00\DD=06 :
        2080006 => "内部错误：未能找到此通知消息。",
        ///// A=2\BB=08\CC=00\DD=07 :
        2080007 => "错误：站内信功能关闭。",
        //// A=2\BB=08\CC=01 : 客户端操作
        ///// A=2\BB=08\CC=01\DD=00 :
        // TODO:
        2080100 => "内部错误：",
        // A=3 : 警告
        /// A=3\BB=00 : 用户
