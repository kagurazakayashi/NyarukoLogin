...
class nyainfomsg {
    public $imsg = array(
        ...
        */
        ...
        /// A=2\BB=05 : 用户资料异常 TODO: -6
        //// A=2\BB=05\CC=00 : 提交用户查询信息异常
        ///// A=2\BB=05\CC=00\DD=00 :
        2050000 => "内部错误：资料查询参数错误。",
        //// A=2\BB=05\CC=01 : 昵称查询
        ///// A=2\BB=05\CC=01\DD=01 :
        2050101 => "内部错误：昵称需要附加唯一编号或格式不符。",
        ///// A=2\BB=05\CC=01\DD=02 :
        2050102 => "内部错误：昵称查找没有成功。",
        ///// A=2\BB=05\CC=01\DD=03 :
        2050103 => "错误：没有找到被提及人的昵称。",
        /// A=2\BB=06 : 函数可用性
