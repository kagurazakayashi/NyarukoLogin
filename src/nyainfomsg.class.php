...
class nyainfomsg {
    public $imsg = array(
        ...
        */
        ...
        //// A=1\BB=03\CC=00 : 用户登录
        ///// A=1\BB=03\CC=00\DD=00 :
        1030000 => '登录成功。',
        ///// A=1\BB=03\CC=00\DD=01 :
        1030001 => '登录成功。你的账户没有对邮箱或手机号进行验证，请尽快验证以确保正常使用。',
        ///// A=1\BB=03\CC=00\DD=02 :
        1030002 => '登录成功。', //登录成功，但是附加了警告信息
        // A=2 : 错误
        /// A=2\BB=00 : 通用
